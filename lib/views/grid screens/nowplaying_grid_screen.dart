...
import '../detail screens/nowplaying_movie_detail_screen.dart';

class NowPlayingGridScreen extends StatelessWidget {
  final List<Results>? nowPlayingResults;
  const NowPlayingGridScreen({super.key, this.nowPlayingResults});
