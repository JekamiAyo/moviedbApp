...
class TrendingMovieDetailPage extends StatelessWidget {
  ...
  const TrendingMovieDetailPage({super.key, required this.result});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        MovieDetailTxt(
                            txt: "Type: ${result.mediaType!.toUpperCase()}"),
                        MovieDetailTxt(txt: "Release: ${result.releaseDate}"),
                        MovieDetailTxt(
                            txt:
                          ...
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                ...
                                style: GoogleFonts.roboto(
                                  color:
                                      const Color.fromARGB(255, 108, 229, 56),
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
...
class MovieDetailTxt extends StatelessWidget {
  const MovieDetailTxt({
    super.key,
    required this.txt,
  });
